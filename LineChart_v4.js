...
(function () {
  ...
  class SamplePrepared extends HTMLElement {
    ...
    async render(resultSet1, _Vrname, _KFName, _YDirection, _S1, _S2, _ReplaceNull, _DateAxes, _Isyear) {
      ...
      //  if (_Isyear === 'yyyy') {
       //   var dt = new Date(resultSet1[i]["TimeDimensionID_YEAR"].description);
      //  } else if (_Isyear === 'MMM') {
         var dt = new Date(resultSet1[i]["DATE"].description);
      //  } else {
         // var values = resultSet1[i]["TimeDimensionID_QUARTER"].description;

         // if (values.charAt(4) === '1') {
          //  values = 'Jan ' + values.substr(0, 4);
         // } else if (values.charAt(4) === '2') {
          //  values = 'Apr ' + values.substr(0, 4);
         // } else if (values.charAt(4) === '3') {
          //  values = 'Jul ' + values.substr(0, 4);
         // } else {
          //  values = 'Oct ' + values.substr(0, 4);
        //  }
         // dt = new Date(values);
        //}
	...
	am4core.Circle,
      ...
      // Series Color
      // {
        // var SC = [am4core.color("#0460a9"),
        // am4core.color("#0460a9"),
        // am4core.color("#0460a9"),
        // am4core.color("#0460a9"),
	// am4core.color("#ec9a1e"),
        // am4core.color("#ec9a1e"),
        // am4core.color("#ec9a1e"),
        // am4core.color("#ec9a1e"),
        // ];
	  ...
	  series0.stroke = am4core.color(_DateAxes[i]);
          if (_YDirection[i] === 'L') {
	    ...
	    square.fill = am4core.color(_DateAxes[i]);
        }
      }
      ...
      //Section 2 
      {
	    ...
	    seriesR0.tensionX = 0.9;
            ...
            var square = bullet.createChild(BS[i]);
	    seriesR0.stroke = am4core.color(_DateAxes[i]);
            square.width = 6;
            square.height = 6;
            square.horizontalCenter = "middle";
            square.verticalCenter = "middle";
	    square.fill = am4core.color(_DateAxes[i]);
            ...
            seriesC0.fill = am4core.color("#0460a9").lighten(0.3);
            ...
            seriesO0.fill = am4core.color("#0460a9").lighten(0.3);
	    ...
	    seriesR1.tensionX = 0.9;
            ...
            var square = bullet.createChild(BS[i]);
	    seriesR1.stroke = am4core.color(_DateAxes[i]);
            square.width = 6;
            square.height = 6;
            square.horizontalCenter = "middle";
            square.verticalCenter = "middle";
	    square.fill = am4core.color(_DateAxes[i]);
            ...
            seriesC1.fill = am4core.color("#0460a9").lighten(0.3);
            ...
            seriesO1.fill = am4core.color("#0460a9").lighten(0.3);
	    ...
	    seriesR2.tensionX = 0.9;
            ...
            var square = bullet.createChild(BS[i]);
	    seriesR2.stroke = am4core.color(_DateAxes[i]);
            square.width = 6;
            square.height = 6;
            square.horizontalCenter = "middle";
            square.verticalCenter = "middle";
	    square.fill = am4core.color(_DateAxes[i]);
            ...
            seriesC2.fill = am4core.color("#0460a9").lighten(0.3);
            ...
            seriesO2.fill = am4core.color("#0460a9").lighten(0.3);
	    ...
	    seriesR3.tensionX = 0.9;
            ...
            var square = bullet.createChild(BS[i]);
	    seriesR3.stroke = am4core.color(_DateAxes[i]);
            square.width = 6;
            square.height = 6;
            square.horizontalCenter = "middle";
            square.verticalCenter = "middle";
	    square.fill = am4core.color(_DateAxes[i]);
            ...
            seriesC3.fill = am4core.color("#0460a9").lighten(0.3);
            ...
            seriesO3.fill = am4core.color("#0460a9").lighten(0.3);
