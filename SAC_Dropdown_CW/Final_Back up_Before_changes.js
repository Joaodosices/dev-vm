(function () {
    ...
    class MultiInput extends HTMLElement {
        ...
        get default() {
            return this._export_settings.default;
        }
        set default(value) {
            value = dfnumber;
            this._export_settings.default = value;
        }
    ...
    function loadthis(that, changedProperties) {
        ...
        if (rowData.length > 0) {
            ...
            // console.log(changedProperties._default);

            // changedProperties._default = dfnumber;

            // console.log(changedProperties._default);
            // _filterInfo = [dfnumber];            
            that.default = dfnumber;
                ...
                function (Controller, JSONModel) {
                    ...
                    var PageController = Controller.extend("myView.Template", {
                        ...
                        onDefaultSelction: function (event) {
                            ...
                            if(dftime>4 && dftime <300){

                            var treeid = "Tree"+that.widgetName;

                            // console.log(that.default);                            
                            
                            dfnumber = that.default;
