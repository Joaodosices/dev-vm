 ...
 /*--------------------------------------------------------------------------------------------------------------- */
        ...
        if (rowData.length > 0) {
            ...
            for (var a = 0; a < rowData[0].length; a++) {
                ...
                var node0 = { text: rowData[0][a].NODENAME.id + " - " + rowData[0][a].DESCRIPTION.id };
                ...
                for (var b = 0; b < rowData[1].length; b++) {
                    ...
                    if (rowData[1][b].PARENTID.id === id0) {
                        ...
                        var node1 = { text: rowData[1][b].NODENAME.id  + " - " + rowData[1][b].DESCRIPTION.id};
                        ...
                        for (var c = 0; c < rowData[2].length; c++) {
                            ...
                            if (rowData[2][c].PARENTID.id === id1) {
                                ...
                                var node2 = { text: rowData[2][c].NODENAME.id  + " - " + rowData[2][c].DESCRIPTION.id};
                                ...
                                for (var d = 0; d < rowData[3].length; d++) {
                                    ...
                                    if (rowData[3][d].PARENTID.id === id2) {
                                        ...
                                        var node3 = { text: rowData[3][d].NODENAME.id  + " - " + rowData[3][d].DESCRIPTION.id};
                                        ...
                                        for (var e = 0; e < rowData[4].length; e++) {
                                            ...
                                            if (rowData[4][e].PARENTID.id === id3) {
                                                ...
                                                var node4 = { text: rowData[4][e].NODENAME.id  + " - " + rowData[4][e].DESCRIPTION.id};
                                                ...
                                                for (var f = 0; f < rowData[5].length; f++) {
                                                    ...
                                                    if (rowData[5][f].PARENTID.id === id4) {
                                                        ...
                                                        var node5 = { text: rowData[5][f].NODENAME.id  + " - " + rowData[5][f].DESCRIPTION.id};
                                                        ...
                                                        for (var g = 0; g < rowData[6].length; g++) {
                                                            ...
                                                            if (rowData[6][g].PARENTID.id === id5) {
                                                                ...
                                                                var node6 = { text: rowData[6][g].NODENAME.id  + " - " + rowData[6][g].DESCRIPTION.id };
                                                                ...
                                                                for (var h = 0; h < rowData[7].length; h++) {
                                                                    ...
                                                                    if (rowData[7][h].PARENTID.id === id6) {
                                                                        ...
                                                                        var node7 = { text: rowData[7][h].NODENAME.id  + " - " + rowData[7][h].DESCRIPTION.id};
