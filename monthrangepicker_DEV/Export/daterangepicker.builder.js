(function () {
    ...
    <fieldset>
      <legend>Date Range Picker Properties</legend>
			<div class="form-group col-xs-12">
				<label class="col-form-label">Calendar Type</label>
    ...
    customElements.define(
      ...
      class MultiselectBuilder extends HTMLElement {
		...
		get calendarType() {
			console.log('>>>>>>>>>>>>builder:get calendarType: '.concat(this.getId("calendarType").value));
          return this.getId("calendarType").value;
        }
        set calendarType(value) {
			console.log('>>>>>>>>>>>>builder:set calendarType: '.concat(value));
          this.getId("calendarType").value = value;
        }
